...
Slack.prototype._request = function (options, callback) {
  ...
  options.params['error_color':'#EE5F5B'] // Hard coded for now
  options.params['warn_color':'##F89406'] // Hard coded for now
  ...
  options.body = JSON.stringify({
    ...
    attachments: this.options.attachments ?JSON.parse( _.template(JSON.stringify(this.options.attachments), options.params, {
      interpolate: /\{\{(.*?)\}\}/g
    })) : null,
